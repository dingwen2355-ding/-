...
@Data
@ApiModel
public class CatalogueGetTableResponse extends BaseResponse {
   @ApiModelProperty("组织系统表id")
   ...
   @ApiModelProperty("表（目录）状态：1待发布；3.初审中；4审核中；5.启用中；8.初审驳回；9复审驳回;-1已停用；")
   private Integer tableState;
   @TableField("table_changed")
   private Integer tableChanged;
   @TableField("table_option")
   private String tableOptioin;
