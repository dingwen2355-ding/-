...
@Data
@ApiModel
public class CatalogueAddSysByOrgIdRequest extends BaseRequest {
   @ApiModelProperty(
      value = "组织节点id",
      required = true
   )
   private @NotNull(
   message = "新增时组织节点id不能为空"
) Long orgId;
   ...
   @ApiModelProperty("服务对象备注")
   private String useRangeDesc;
   @ApiModelProperty("上线时间m,格式YYYY/MM/DD")
   private String upTime;
   @ApiModelProperty("建成时间,格式YYYY/MM/DD")
   ...
   @ApiModelProperty("【系统部署位置备注】-> 部署环境")
   private String deployLocationDesc;
   @ApiModelProperty("【接入网络类型】->承载网络")
   private String netType;
   @ApiModelProperty("【接入网络类型备注】-> 承载网络备注")
   private String netTypeDesc;
   @ApiModelProperty("【信息安全等保级别备注】-> 等保定级备注 ")
