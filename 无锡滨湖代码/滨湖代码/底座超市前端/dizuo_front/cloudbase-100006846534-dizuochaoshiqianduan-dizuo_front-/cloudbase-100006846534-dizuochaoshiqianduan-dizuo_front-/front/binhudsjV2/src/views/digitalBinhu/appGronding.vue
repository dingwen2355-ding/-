        ...
        <div class="search-box-wrap">
            <div class="search-box _flexw">
                <template v-if="aRecommend && aRecommend.length > 0">
                    <comList-block :data="aRecommend" :params="{ ...oParams }"></comList-block>
                </template>
                <template v-else>
...
export default {
    ...
    data() {
        return {
            ...
            nDataCount: 0,
            oParams: {
                title: 'appName', details: 'remark', unit: 'deptName'
            },
        }
    },
    computed: {},
    ...
    methods: {
        ...
        fReuest() {
            // console.log(111)
            this.currentPage4 = 1;
            this.fRequestApplicationApplyForList();
        },
        // 去详情页面
        fGoToDetails(item) {
            // console.log(item)
        ...
        fGetSqsjList(replayStatus) {
            ...
            $.ajax({
                url: `https://2.21.138.89:11511/cmApp/replayList?pageNum=${1}&pageSize=${99}`,
                method: 'post',
                headers: {
                ...
                this.nDataCount = res.data.total;
            })
        },
        // 根据申请人查询应用申请
