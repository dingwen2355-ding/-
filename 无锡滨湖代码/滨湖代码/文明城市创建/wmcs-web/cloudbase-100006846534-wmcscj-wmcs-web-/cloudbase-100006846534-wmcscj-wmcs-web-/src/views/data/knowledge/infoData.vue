                ...
                <el-row class="show-flex-r wrap" :gutter="20">
                    ...
                    <el-col :span="24">
                        <el-form-item label="内容" prop="content">
                            <!-- 富文本框 -->
                            <!-- <baseQuill v-model="item.content" :disable="baseDisable" /> -->
                            <div v-if="!baseDisable">
...
<script>
import { InfoKnowledge, addKnowledge, editKnowledge } from '@/api/data/knowledge'
export default {
    props: {
