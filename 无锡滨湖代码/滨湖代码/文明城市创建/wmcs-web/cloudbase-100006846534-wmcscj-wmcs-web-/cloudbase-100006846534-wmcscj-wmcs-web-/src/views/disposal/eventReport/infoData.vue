    ...
    <div slot="body" v-loading="v_loadig" class="td-form-content-wap">
      ...
      >
        <el-row class="show-flex-r wrap" :gutter="20">
          <el-col :span="24" 
                 v-if="regionShow == true">
            <el-form-item label="◇ 按街道筛选事发点位 " prop="regionCode">
              <searchRegionDept
                ref="regionId"
                noLabel
                useType="form"
          ...
          <el-col :span="12">
            <el-form-item label="事发街道" prop="name">
              <div class="td-form-val">
                <el-input v-model="item.regionName" disabled="false"/>
              </div>                
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
    ...
    methods: {
        ...
        changeCheckPointType(data) {
            ...
            // console.log(this.item.checkPointsTypeId)
            // if(this.item.checkPointsTypeId != '') {
