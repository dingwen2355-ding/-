            ...
            <div slot="table">
                <div>
                    ...
                    <el-table-column label="事件来源" width="80">
                        ...
                        <el-table-column label="原责任单位" prop="oldDeptName" width="140" />
                        <el-table-column label="申请原因" prop="reason" min-width="120" />
                        <el-table-column label="申请部门" prop="applyDeptName" width="100" />
                        <el-table-column label="申请时间" prop="appealTime" width="170" /><el-table-column label="状态" width="80">
                            <template slot-scope="scope">
                                <div>
                        ...
                        <el-table-column label="现责任单位" prop="newDeptName" width="140" />
...
import { appeal, appealApprove } from "@/api/workflow/workflow";
import diaAppealApprove from './diaAppealApprove.vue'
export default {
    mixins: [reportMixins],
    ...
    methods: {
        getList(searchData) {
            this.getTableData(appeal, searchData)
        },
        toInfo(item) {
            this.$router.push(
