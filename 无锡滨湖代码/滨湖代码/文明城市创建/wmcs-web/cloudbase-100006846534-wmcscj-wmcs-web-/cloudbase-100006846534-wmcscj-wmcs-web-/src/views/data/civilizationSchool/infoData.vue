<template>
    <baseKanbanInfo :title="useType == 'add' ? '添加文明校园' : ('文明校园 / ' + (item.name || ''))">
        ...
        <div slot="body" v-loading="v_loadig" class="td-form-content-wap">
            ...
            >
                ...
                <el-row class="show-flex-r wrap" :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="学校性质" prop="attribute">
                            <dirtCivilizationSchoolAttribute
                                ref="civilizationSchoolAttribute"
                                noLabel
                                useType="form"
                                allWidth="100%"
                                :disabled="baseDisable"
                                @change="(v) => { item.attribute = v['civilizationSchoolAttribute'] || '' }"
                            />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="校园类型" prop="selectType">
                            <dirtCivilizationSchoolType
                                ref="civilizationSchoolType"
                                noLabel
                                useType="form"
                                allWidth="100%"
                                :disabled="baseDisable"
                                @change="(v) => { item.selectType = v['civilizationSchoolType'] || '' }"
                            />
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        <el-form-item label="法定代表人" prop="legalLeader">
                            <div v-if="!baseDisable">
                                <el-input v-model="item.legalLeader" />
                            </div>
                            <div v-else class="td-form-val">
                                {{ item.legalLeader || '' }}
                            </div>
                    ...
                    <el-col :span="12">
                        <el-form-item label="电话" prop="legalTel">
                            <div v-if="!baseDisable">
                                <el-input v-model="item.legalTel" />
                            </div>
                            <div v-else class="td-form-val">
                                {{ item.legalTel || '' }}
                            </div>
                    ...
                    <el-col :span="12">
                        <el-form-item label="电话" prop="creatorTel">
                            <div v-if="!baseDisable">
                        ...
                        <el-form-item label="宣传图" prop="icon">
                            ...
                            <div class="w-100">
                                <baseUpFile
                                    ...
                                    :showDel="!baseDisable"
                                    onlyImg
                                    tableName="data_civilization_school"
                                    fieldName="icon"
                                />
...
<script>
import { infoCivilizationSchool, addCivilizationSchool, editCivilizationSchool } from '@/api/data/civilizationSchool'
export default {
    props: {
    ...
    methods: {
        ...
        getInfo() {
            ...
            this.v_loadig = true
            // 获取详情接口
            infoCivilizationSchool(this.id)
            .then(data => {
                let v = data.data
                ...
                _this.$refs.civilizationSchoolAttribute.setValWithChange(v.attribute);
                _this.$refs.civilizationSchoolType.setValWithChange(v.selectType)
