<template>
    <baseKanbanInfo :title="useType == 'add' ? '添加权重值' : ('权重信息 / ' + (item.name || ''))">
        ...
        <div slot="body" v-loading="v_loadig" class="td-form-content-wap">
            ...
            >
                ...
                <el-row class="show-flex-r wrap" :gutter="20">
                    ...
                    <el-col :span="12">
                        <el-form-item label="权重值" prop="val">
                            <div v-if="!baseDisable" >
                    ...
                    <el-col :span="24">
                        <el-form-item label="权重描述" prop="description">
                            <div v-if="!baseDisable">
...
<script>
import { infoWeight, addWeight, editWeight } from '@/api/quota/weight'
export default {
    props: {
    ...
    data() {
        return {
            ...
            rules: {
                name: [{ required: true, message: '请输入权重名称', trigger: ['blur', 'change'] }]
            }
        }
    },
    computed: {
