                        ...
                        <el-table-column label="操作" width="100" fixed="right">
                            <template slot-scope="scope">
                                <div class="show-flex-r a-c">
                                    <div class="zr-link-p unline m-5" @click="toHandle(scope.row)">处置</div>
                                </div>
                            </template>
                        </el-table-column>
                    </el-table>
...
import { handle } from "@/api/workflow/workflow";
export default {
    mixins: [reportMixins],
    data() {
        return {}
    ...
    methods: {
        getList(searchData) {
            this.getTableData(handle, searchData)
        },
        toHandle(item) {
            this.$router.push(
