...
export default {
    props: {
        labelName: { type: String, default: '村镇类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'civilizationTownType' },
        placName: { type: String, default: '请选择村镇类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.dirtCivilizationTownType'(newVal, oldVal) {
