...
export default {
    props: {
        labelName: { type: String, default: '所选街道' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'regionId' },
        placName: { type: String, default: '所选街道' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.getRegionDeptList'(newVal, oldVal) {
    ...
    methods: {
        init(val) {
            ...
            if (this.filterType == '2') {
                oV = oV.filter(i => { return i.type == '2' })
            }
            let v = oV
        ...
        getSearchValue() {
            ...
            returnVal[this.keyName] = this.value[this.value.length - 1]
            return returnVal
        }
    }
}
