                    ...
                    <baseSearchForm ref="searchTable" @getList="getList" @search="startSearch" @reset="resetQuery">
                        <div slot="customQuery" class="listSearch">
                            <div class="search-line">
                                ...
                                <normalSearch ref="userName" labelName="用户账号" keyName="userName" placName="请输入用户账号" />
                        ...
                        <div slot="table">
                            ...
                            <el-table v-loading="tableListLoding" stripe size="mini" :data="tableData">
                                <el-table-column label="登录账号" prop="userName" width="200" />
                                <el-table-column label="姓名" prop="nickName" width="150" />
                                <el-table-column label="角色" prop="roleNames" min-width="200" />
                                <el-table-column label="所属机构" prop="deptName" min-width="200" />
                                <el-table-column label="联系电话" prop="phonenumber" min-width="100" />
