            ...
            <baseSearchForm ref="searchTable" @getList="getList" @search="startSearch" @reset="resetQuery">
                ...
                <div slot="table">
                    ...
                    <el-table v-loading="tableListLoding" stripe size="mini" :data="tableData">
                        <el-table-column label="志愿者名称" prop="name" width="200" />
                        <el-table-column label="所属区划" prop="regionName" width="200" />
                        <el-table-column label="联系电话" prop="phone" width="150" />
                        <el-table-column label="身份号码" prop="cardnumber" width="200" />
                        <el-table-column label="单位名称" prop="corporateName" min-width="300" />
                        <el-table-column label="详细住址" prop="address" min-width="300" />
...
import { listVolunteer } from '@/api/data/volunteer'
export default {
    mixins: [reportMixins],
    props: {
        usenotice: {
