...
export default {
    props: {
        labelName: { type: String, default: '点位类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'checkPointsTypeId' },
        placName: { type: String, default: '请选择点位类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.getCheckPointsTypeList'(newVal, oldVal) {
