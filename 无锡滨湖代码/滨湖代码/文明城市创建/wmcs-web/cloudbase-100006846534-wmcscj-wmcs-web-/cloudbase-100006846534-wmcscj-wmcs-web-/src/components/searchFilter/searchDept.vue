...
export default {
    props: {
        labelName: { type: String, default: '所选单位' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'deptId' },
        placName: { type: String, default: '所选单位' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.getDeptList'(newVal, oldVal) {
