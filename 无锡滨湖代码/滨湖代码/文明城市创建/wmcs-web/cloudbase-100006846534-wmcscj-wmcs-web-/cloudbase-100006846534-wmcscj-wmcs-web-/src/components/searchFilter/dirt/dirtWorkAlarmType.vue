...
export default {
    props: {
        labelName: { type: String, default: '告警类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'alarmTypeId' },
        placName: { type: String, default: '请选择告警类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.dirtAlarmType'(newVal, oldVal) {
