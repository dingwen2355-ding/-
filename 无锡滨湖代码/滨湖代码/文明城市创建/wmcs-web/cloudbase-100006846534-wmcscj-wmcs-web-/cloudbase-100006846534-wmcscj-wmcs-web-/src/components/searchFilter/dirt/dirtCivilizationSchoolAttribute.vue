...
export default {
    props: {
        labelName: { type: String, default: '文明校园性质' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'civilizationSchoolAttribute' },
        placName: { type: String, default: '请选择校园性质' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    data() {
        return {
            api: 'dirtCivilizationSchoolAttribute',
            options: [],
    ...
    watch: {
        '$store.state.searchFilter.dirtCivilizationSchoolAttribute'(newVal, oldVal) {
