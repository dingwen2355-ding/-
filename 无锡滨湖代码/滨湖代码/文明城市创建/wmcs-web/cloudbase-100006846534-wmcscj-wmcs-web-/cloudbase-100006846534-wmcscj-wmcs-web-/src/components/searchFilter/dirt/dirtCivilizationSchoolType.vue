...
export default {
    props: {
        labelName: { type: String, default: '文明校园类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'civilizationSchoolType' },
        placName: { type: String, default: '请选择校园类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    data() {
        return {
            api: 'dirtCivilizationSchoolType',
            options: [],
    ...
    watch: {
        '$store.state.searchFilter.dirtCivilizationSchoolType'(newVal, oldVal) {
