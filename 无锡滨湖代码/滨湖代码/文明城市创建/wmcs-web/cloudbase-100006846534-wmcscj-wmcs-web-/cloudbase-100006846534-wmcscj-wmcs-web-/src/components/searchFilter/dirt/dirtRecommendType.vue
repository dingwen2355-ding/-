...
export default {
    props: {
        labelName: { type: String, default: '推荐类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'recommendTypeId' },
        placName: { type: String, default: '请选择推荐类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.dirtRecommendType'(newVal, oldVal) {
