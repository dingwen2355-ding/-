...
export default {
    props: {
        labelName: { type: String, default: '人员类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'checkUserType' },
        placName: { type: String, default: '请选择人员类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.dirtCheckUserType'(newVal, oldVal) {
