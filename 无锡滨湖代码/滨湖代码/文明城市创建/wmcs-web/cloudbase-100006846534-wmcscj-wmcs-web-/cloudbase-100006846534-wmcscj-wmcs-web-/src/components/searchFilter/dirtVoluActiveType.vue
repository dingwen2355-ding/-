...
export default {
    props: {
        labelName: { type: String, default: '活动类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'voluActiveType' },
        placName: { type: String, default: '请选择活动类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.dirtVolunteerActiveType'(newVal, oldVal) {
