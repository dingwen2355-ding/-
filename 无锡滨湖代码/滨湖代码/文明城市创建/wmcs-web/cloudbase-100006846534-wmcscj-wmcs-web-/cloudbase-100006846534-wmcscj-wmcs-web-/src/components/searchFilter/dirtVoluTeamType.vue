...
export default {
    props: {
        labelName: { type: String, default: '团队类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'voluTeamType' },
        placName: { type: String, default: '请选择团队类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.dirtVolunteerTeamType'(newVal, oldVal) {
