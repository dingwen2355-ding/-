...
export default {
    props: {
        labelName: { type: String, default: '所选组织' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'unityDeptId' },
        placName: { type: String, default: '所选组织' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.getUnityDeptList'(newVal, oldVal) {
