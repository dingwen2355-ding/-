...
export default {
    props: {
        labelName: { type: String, default: '时间配置' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'timeconfigId' },
        placName: { type: String, default: '请选择时间配置' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.getTimeConfigList'(newVal, oldVal) {
