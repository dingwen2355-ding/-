...
export default {
    props: {
        labelName: { type: String, default: '巡查任务状态' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'taskStatusId' },
        placName: { type: String, default: '请选择状态' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.dirtCheckTask'(newVal, oldVal) {
