...
<script>
import { getPointsContentList } from "@/api/data/checkPointsType";

export default {
  props: {
    labelName: { type: String, default: "检查项目" },
    noLabel: { type: Boolean, default: false },
    keyName: { type: String, default: "checkItemId" },
    keyLabelName: { type: String, default: "checkItemName" },
    placName: { type: String, default: "请选择检查项目" },
    disabled: {
      type: Boolean,
      default: false
    },
