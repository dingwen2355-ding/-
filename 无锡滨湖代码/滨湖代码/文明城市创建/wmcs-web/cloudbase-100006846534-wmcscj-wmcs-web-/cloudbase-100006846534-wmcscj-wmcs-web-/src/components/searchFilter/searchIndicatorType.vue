...
export default {
    props: {
        labelName: { type: String, default: '指标类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'indicatorTypeId' },
        placName: { type: String, default: '请选择指标类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    watch: {
        '$store.state.searchFilter.getIndicatorTypeList'(newVal, oldVal) {
