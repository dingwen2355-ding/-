...
export default {
    props: {
        labelName: { type: String, default: '典型人物类型' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'civilizationAdvancedType' },
        placName: { type: String, default: '请选择类型' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    data() {
        return {
            api: 'dirtCivilizationAdvancedType',
            options: [],
    ...
    watch: {
        '$store.state.searchFilter.dirtCivilizationAdvancedType'(newVal, oldVal) {
