...
export default {
    props: {
        labelName: { type: String, default: '层级' },
        noLabel: { type: Boolean, default: false },
        keyName: { type: String, default: 'civilizationSelectLevel' },
        placName: { type: String, default: '层级' },
        disabled: {
            type: Boolean,
            default: false
        },
    ...
    data() {
        return {
            api: 'dirtCivilizationSelectLevel',
            options: [],
    ...
    watch: {
        '$store.state.searchFilter.dirtCivilizationSelectLevel'(newVal, oldVal) {
