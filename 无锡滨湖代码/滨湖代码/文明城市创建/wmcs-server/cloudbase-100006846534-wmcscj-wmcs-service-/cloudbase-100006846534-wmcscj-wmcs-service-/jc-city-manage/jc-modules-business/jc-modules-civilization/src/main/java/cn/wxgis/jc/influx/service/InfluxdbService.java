package cn.wxgis.jc.influx.service;

import cn.wxgis.jc.influx.config.InfluxDBConfig;
...
public class InfluxdbService {
    ...
    public void insert(String measurement, Map<String, String> tags, Map<String, Object> fields, long date) {
        influxDbBuild();
        Point.Builder builder = Point.measurement(measurement);
        builder.time(date, TimeUnit.MILLISECONDS);
        builder.tag(tags);
        builder.fields(fields);
        influxDB.write(influxDBConfig.database, "", builder.build());
    }
