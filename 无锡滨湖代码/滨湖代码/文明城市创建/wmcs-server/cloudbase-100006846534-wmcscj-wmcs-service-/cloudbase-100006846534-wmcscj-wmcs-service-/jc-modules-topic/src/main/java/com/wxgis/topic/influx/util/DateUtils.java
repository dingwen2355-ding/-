...
public class DateUtils {
    ...
    public static void main(String[] args) {
        long time = com.alibaba.fastjson2.util.DateUtils.parseMillis(com.alibaba.fastjson2.util.DateUtils.format(com.alibaba.fastjson2.util.DateUtils.parseDate(parseDateToString(new Date(), YYYY_MM_DD_HH_MM_SS))));
