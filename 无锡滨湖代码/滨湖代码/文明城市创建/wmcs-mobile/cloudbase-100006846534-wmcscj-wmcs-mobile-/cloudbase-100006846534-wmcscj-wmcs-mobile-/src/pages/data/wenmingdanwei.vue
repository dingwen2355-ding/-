        ...
        <div class="searchPanel">
            <uni-forms ref="form" :modelValue="page" label-position="left" label-width="120">
                ...
                <div
                    ...
                    <!-- <uni-forms-item label="评选季度" name="selectDate" v-show="showMore" style="width: 30%;">
                        <uni-data-select style="width: 30%;" v-model="page.selectDate" :localdata="dates" @change="search()"
...
export default {
    ...
    methods: {
        ...
        toDetail(row) {
            ...
            uni.navigateTo({
                url: "./../data/wenmingdanweiDetail?id=" + row.id
            });
            // } else {
            //     let str = JSON.stringify(row)
            //     uni.navigateTo({
        ...
        getData(cb) {
            ...
            this.$api.companyPage(this.page).then(r => {
                uni.hideLoading();
