    ...
    <view class="content">
        ...
        <template v-if="current == 0">
            ...
            <div class="field">
                ...
                <div class="value">
                    <uni-tag v-if="row.status == 20" :mark="true" type="primary" size="small" text="待分派"></uni-tag>
                    <uni-tag v-if="row.status == 30" :mark="true" type="success" size="small" text="待受理"></uni-tag>
                    <uni-tag v-if="row.status == 40" :mark="true" type="error" size="small" text="待处置"></uni-tag>
                    <uni-tag v-if="row.status == 50" :mark="true" type="warning" size="small" text="待核查"></uni-tag>
                    <uni-tag v-if="row.status == 60" :mark="true" type="info" size="small" text="已办结"></uni-tag>
                </div>
            </div>
            <div class="field">
                <div class="label">处置时限：</div>
                <div class="value">{{ row.handleTimelimit }}</div>
            </div>
            <div class="field">
