<template>
    <view class="content">
        ...
        <div class="field">
            ...
            <div class="value">{{ row.creditCode || '/'  }}</div>
        </div>
        <!-- <div class="field">
            <div class="label">平台展示名称：</div>
            <div class="value">{{ row.platname }}</div>
        </div> -->
        <div class="field">
            <div class="label">法定代表：</div>
            <div class="value">{{ row.legalLeader || '/' }}</div>
        </div>
        <div class="field">
            <div class="label">电话：</div>
            <div class="value" v-html="row.legalTel || '/' "></div>
        </div>
        <div class="field">
...
export default {
    ...
    onLoad(query) {
        this.$api.companyDetail(query.id).then(res => {
            this.row = res.data
            this.files = [];
