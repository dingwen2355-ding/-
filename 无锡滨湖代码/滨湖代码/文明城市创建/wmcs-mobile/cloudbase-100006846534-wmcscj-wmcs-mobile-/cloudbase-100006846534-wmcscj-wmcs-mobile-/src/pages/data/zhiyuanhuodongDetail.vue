<template>
    <view class="content">
        ...
        <div class="field">
            ...
            <div class="value">{{ row.startTime }}</div>
        </div>
        <div class="field">
            <div class="label">结束时间：</div>
            <div class="value">{{ row.endTime }}</div>
        </div>
        <div class="field">
            <div class="label">活动内容：</div>
            <div class="value" v-html="row.details"></div>
        </div>
        <div class="field">
...
export default {
    ...
    onLoad(query) {
        this.$api.volunteerActivityDetail(query.id).then(res => {
            this.row = res.data
            this.files = [];
