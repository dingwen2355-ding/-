<template>
    <view class="content">
        ...
        <div class="field">
            ...
            <div class="value">{{ getSelectType(row.recommendType) }}</div>
        </div>
        <div class="field">
        ...
        <div class="field">
            <div class="label">获评荣誉：</div>
            <div class="value">{{ row.selectType  || '/' }}</div>
        </div>
        <div class="field">
            <div class="label">性别：</div>
            <div class="value">{{ row.sex == 1?"男":"女" }}</div>
        </div>
        <div class="field">
            <div class="label">生日：</div>
            <div class="value">{{ row.birth || '/' }}</div>
        </div>
        <div class="field">
        ...
        <div class="field">
            ...
            <div class="value">{{ row.company || '/'  }}</div>
        </div>
        <div class="field">
            <div class="label">单位职务：</div>
            <div class="value" v-html="row.position || '/' "></div>
        </div>
        <div class="field">
            <div class="label">政治面貌：</div>
            <div class="value">{{ row.politicsStatus || '/'  }}</div>
        </div>
        <div class="field">
            <div class="label">推荐来源：</div>
            <div class="value" v-html="row.selectSource || '/' "></div>
        </div>
        <div class="field">
        ...
        <div class="field">
            ...
            <div class="value" v-html="row.mediaNews || '/' "></div>
        </div>
        <div class="field">
            <div class="label">媒体新闻：</div>
...
export default {
    ...
    onLoad(query) {
        this.$api.advancedDetail(query.id).then(res => {
            this.row = res.data
            this.files = [];
