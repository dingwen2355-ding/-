<template>
  <div class="avue-top">
    ...
    <div class="top-bar__right">
      ...
      <el-tooltip
        effect="dark"
        :content="userInfo.tenant_id + '/' + userInfo.user_name"
        placement="bottom"
      >
      ...
      <el-dropdown>
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <!-- <el-dropdown-item>
            <router-link to="/front">前台</router-link>
          </el-dropdown-item> -->
<!--          <el-dropdown-item @click.native="routeToManInfo">
            {{ $t("navbar.userinfo") }}
          </el-dropdown-item>-->
          <el-dropdown-item @click.native="routeToFront">前台</el-dropdown-item>
          <el-dropdown-item
      ...
      this.$confirm(this.$t("logoutTip"), this.$t("tip"), {
        ...
        this.$store.dispatch("LogOut").then(() => {
          ...
          getSsoLogoutUri().then((res) => {
            //window.open(res.data.data,"_self").close();
