      ...
      <basic-container ref="container">
        ...
        >
          ...
          <template slot-scope="{ row }" slot="roleName">
            <el-tag><div :style="{color:row.roleName.includes('角色篡改')?'red':'' }">{{ row.roleName }}</div></el-tag>
          </template>
          <template slot-scope="{ row }" slot="phone">
            <span :style="{ color: row.phone == '手机号码篡改' ? 'red' : '' }">{{ row.phone }}</span>
          </template>
...
export default {
          ...
          },
          {
            ...
            column: [
              ...
              },
              {
                label: "应用",
                type: "select",
                dicUrl: "/api/squirrel-szbh/bhapplicationmanagement/getList",
                props: {
                  label: "name",
                  value: "id",
                },
  ...
  methods: {
    ...
    rowSave(row, done, loading) {
      ...
      row.managementId = row.managementId.join(",");
      add(row).then(
        () => {
          this.initFlag = false;
          this.onLoad(this.page);
