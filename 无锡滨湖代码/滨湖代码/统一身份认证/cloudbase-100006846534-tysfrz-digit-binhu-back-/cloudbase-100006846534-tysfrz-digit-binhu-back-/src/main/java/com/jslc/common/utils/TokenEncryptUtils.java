...
public class TokenEncryptUtils {
    // 编码密码,可自定义
//    private static final String ENCODED_PASSWORD = "lanchuang";
     ...
     * @return
     */
    public static String encoded(String appId,String appSecret) {
        return strToHex(encodedString(appId, appSecret));
    }
     ...
     * @return
     */
    public static String decoded(String str,String appSecret) {
        String hexStr = null;
        try {
        ...
        if (hexStr != null) {
            hexStr = encodedString(hexStr, appSecret);
        }
        return hexStr;
    }
