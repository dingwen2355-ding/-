...
package com.jslc.modules.job.utils;
...
import com.jslc.modules.job.task.ITask;
...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            ITask task = SpringUtil.getBean(scheduleJob.getBeanName(), ITask.class);
            task.run(scheduleJob.getParams(), scheduleJob.getJobId());
            //任务执行总时长
