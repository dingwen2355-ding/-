<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="4" :sm="8">
            <a-form-item label="企业名称">
              <j-input placeholder="请输入企业名称" v-model="queryParam.corpName"></j-input>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="8">
            <a-form-item label="法人代表">
              <j-input placeholder="请输入法人代表" v-model="queryParam.operManName"></j-input>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="8">
            <a-form-item label="地址">
              <j-input placeholder="请输入地址" v-model="queryParam.addr"></j-input>
            </a-form-item>
          </a-col>
          <a-col :md="4" :sm="8">
            <span style="float: left; overflow: hidden" class="table-page-search-submitButtons">
              ...
              <a-button type="primary" icon="download" @click="handleExportXls('个体户年报党建信息')">导出</a-button>
            </span>
          </a-col>
        </a-row>
      </a-form>
    ...
    <div class="table-operator" style="border-top: 5px">
      ...
      <!--      <a-button type="primary" icon="download" @click="handleExportXls('企业党建信息')">导出</a-button>-->
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          title: '从业人数',
          align: 'center',
          dataIndex: 'pracPersonNumnvm'
        }
      ],
      url: {
        list: '/gthparty/list',
        // delete: "/message/sysMessage/delete",
        deleteBatch: '/gthparty/deleteBatch',
        exportXlsUrl: "gthparty/exportXls",
        importExcelUrl: "gthparty/importExcel",
      },
      queryParam: {},
      /* 排序参数 */
      isorter: {
