  ...
  <div class="process-panel__container" :style="{ width: `${this.width}px` }">
    <el-collapse v-model="activeTab">
      ...
      <!-- <el-collapse-item name="condition" v-if="formVisible" key="form">
        ...
        <element-form :id="elementId" :type="elementType" :formObj="formObj" />
      </el-collapse-item> -->
...
export default {
  ...
  methods: {
    ...
    initModels() {
      ...
      console.log(window.bpmnInstances.create, 'this.bpmnModeler.get("bpmnFactory")')
    ...
    initFormOnChanged(element) {
      ...
      //把这个挂载到vuex上面
      this.$store.state.bpmn.elementBusinessObject = this.elementBusinessObject
      ...
      // console.log(this.elementType,'this.elementTypethis.elementType');
      this.formVisible = this.elementType === 'UserTask' || this.elementType === 'StartEvent'
      console.log(this.formVisible, 'this.formVisiblethis.formVisible')
    },
    beforeDestroy() {
