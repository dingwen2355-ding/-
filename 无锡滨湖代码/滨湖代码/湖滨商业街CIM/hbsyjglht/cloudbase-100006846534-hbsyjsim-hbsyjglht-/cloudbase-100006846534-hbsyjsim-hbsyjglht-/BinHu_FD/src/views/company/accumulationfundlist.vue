...
<!--            </a-row>-->
    ...
    <accumulation-fund-modal ref="modalForm" @ok="modalFormOk"></accumulation-fund-modal> <!-- 字典数据 -->
  </a-card>
</template>
...
<script>
  ...
  import AccumulationFundModal from './modules/AccumulationFundModal'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'

  export default {
    name: "AccumulationFundList",
    mixins: [JeecgListMixin],
    components: {AccumulationFundModal},
    data() {
      return {
        columns: [
          {
        ...
        url: {
          list: "/company/acc/getlist",
          delete: "/company/acc/delete"
        },
      }
    },
    created() {
