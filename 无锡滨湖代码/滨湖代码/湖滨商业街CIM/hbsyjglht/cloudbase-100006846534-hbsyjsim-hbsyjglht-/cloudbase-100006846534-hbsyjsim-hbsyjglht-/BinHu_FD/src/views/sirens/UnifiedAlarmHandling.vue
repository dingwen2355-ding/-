<template>
  <div>
    <a-card :bordered="false">
      ...
      <!-- 表单区域 -->
      <alarm-processing-modal ref="modalForm" @ok="modalFormOk"></alarm-processing-modal>
    </a-card>
  </div>
</template>

<script>
import AlarmProcessingModal from './modules/AlarmProcessingModal'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'
import JDictSelectTag from '@/components/dict/JDictSelectTag'
import moment from 'moment'

export default {
  name: 'UnifiedAlarmHandling',
