...
<!--            </a-row>-->
    ...
    <water-elec-modal ref="modalForm" @ok="modalFormOk"></water-elec-modal> <!-- 字典数据 -->
  </a-card>
</template>
...
<script>
  ...
  import WaterElecModal from './modules/WaterElecModal'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'

  export default {
    name: "WaterElecList",
    mixins: [JeecgListMixin],
    components: {WaterElecModal},
    data() {
      return {
        columns: [
          {
        ...
        url: {
          list: "/company/waterelec/getlist",
          delete: "/company/waterelec/delete"
        },
      }
    },
    created() {
