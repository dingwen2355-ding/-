<template>
  <a-card :bordered="false">
    ...
    <shareholder-modal ref="modalForm" @ok="modalFormOk"></shareholder-modal> <!-- 字典数据 -->
  </a-card>
</template>
...
<script>
  ...
  import ShareholderModal from './modules/ShareholderModal'
  import {JeecgListMixin} from '@/mixins/JeecgListMixin'

  export default {
    name: "ShareholderList",
    mixins: [JeecgListMixin],
    components: {ShareholderModal},
    data() {
      return {
        columns: [
          {
        ...
        url: {
          list: "/company/shareholder/getlist",
          delete: "/company/shareholder/delete"
        },
      }
    },
    created() {
    ...
    methods: {
      ...
      // 添加字典数据
      handleAdd() {
        this.$refs.modalForm.add(this.qyid);
