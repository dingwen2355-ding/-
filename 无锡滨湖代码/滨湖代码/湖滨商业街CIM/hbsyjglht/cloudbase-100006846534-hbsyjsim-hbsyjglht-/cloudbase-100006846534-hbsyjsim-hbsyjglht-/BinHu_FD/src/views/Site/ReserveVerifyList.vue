      ...
      <div>
        ...
        <a-table
          ...
          <span slot="action" slot-scope="text, record">
            <a v-if="type=='audit'" @click="handleAudit(record)">审核</a>

            <a-popconfirm  v-if="type=='record'" title="确定取消吗?" @confirm="() => handleDelete(record.id)">
                  <a :disabled="record.state=='0'">取消申请</a>
                </a-popconfirm>
          </span>
    ...
    export default {
      ...
      data () {
        return {
          ...
          url: {
            list: "/reserve/reserveRecord/reserveRecord",
            delete: "/reserve/reserveRecord/delete",
            deleteBatch: "/reserve/reserveRecord/deleteBatch",
            exportXlsUrl: "reserve/reserveRecord/exportXls",
            importExcelUrl: "reserve/reserveRecord/importExcel",
         },
      }
    },
    computed: {
