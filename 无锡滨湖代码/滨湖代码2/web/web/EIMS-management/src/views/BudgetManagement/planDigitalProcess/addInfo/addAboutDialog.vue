      ...
      <div class="info_body" v-loading="loading">
        ...
        >
          <el-form-item label="名称" prop="fileName">
            <el-input clearable v-model="form.fileName" placeholder="请输入名称" style="width: 610px"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    submitAll() {
      this.loading = true
      let params = { addPlanNumDataBeans: [], updatePlanNumDataBeans: [] }
      ...
      if (this.fileList) {
        for (let item of this.fileList) {
          ...
          params.addPlanNumDataBeans.push(this.newFormD)
        }
      }
      ...
      Axios.post(url, params).then((res) => {
        ...
        if (res.data.code == 200) {
          ...
          this.$emit('success', this.newFormD.planNumId)
          this.reset()
          this.$emit('update:dialogVisible', false)
        } else {
