    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="待审核" name="second">
        <div style="height: 750px; overflow: scroll">
          <el-table v-loading="loading" class="tableInfo" border :data="tableNotAuditData" style="width: 100%">
        ...
        <el-pagination
          ...
          :current-page.sync="pageNotAudit"
      ...
      <el-tab-pane label="已审核" name="first">
        <section class="AlarmRecord">
          ...
          <div style="height: 735px; overflow: scroll">
            <el-table v-loading="loading" class="tableInfo" border :data="tableAuditData" style="width: 100%">
              <el-table-column type="index" label="编号" width="50"></el-table-column>
              <el-table-column prop="name" label="名称"></el-table-column>
              <el-table-column prop="emergencyTypeName" label="类型"></el-table-column>
              <el-table-column prop="levelName" label="级别"></el-table-column>
  ...
  methods: {
    ...
    queryAuditTableList() {
      ...
      if (this.searchForm.planType) {
        params.emergencyTypeId = this.searchForm.planType.join(',')
      }
    ...
    handleShare(row) {
      ...
      let url = '/gtw/EIMS-management/share-plan'
      let params = {
        id: row.id,
