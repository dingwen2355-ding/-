...
function baiduMap() {
  ...
  baiduMap.SymbolShapeType = { // 线上的样式
    BMap_Symbol_SHAPE_CIRCLE: 'BMap_Symbol_SHAPE_CIRCLE', // 圆形，默认半径为1rem
    BMap_Symbol_SHAPE_RECTANGLE: 'BMap_Symbol_SHAPE_RECTANGLE', // 矩形，默认宽度4rem、高度2rem
    BMap_Symbol_SHAPE_RHOMBUS: 'BMap_Symbol_SHAPE_RHOMBUS', // 菱形，默认外接圆半径10rem
    BMap_Symbol_SHAPE_STAR: 'BMap_Symbol_SHAPE_STAR', // 五角星，五角星外接圆半径为10rem
