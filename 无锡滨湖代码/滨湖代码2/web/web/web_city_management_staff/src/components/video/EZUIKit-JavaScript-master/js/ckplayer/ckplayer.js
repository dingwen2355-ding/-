...
(function () {
  var CKobject = {
    ...
    browser: function () {
      ...
      var rSafari2 = /(safari)\/([\w.]+)/
      var mozilla = /(mozilla)\/([\w.]+)/
      var mobile = /(mobile)\/([\w.]+)/
      var c = u.toLowerCase()
    ...
    embedSWF: function (C, D, N, W, H, V, P) {
      ...
      var g = false
      var j = document
      var r = 'http://www.macromedia.com/go/getflashplayer'
      var t = '<a href="' + r + '" target="_blank">请点击此处下载安装最新的flash插件</a>'
      var error = {
        w: '您的网页不符合w3c标准，无法显示播放器',
        f: '您没有安装flash插件，无法播放视频，' + t,
        v: '您的flash插件版本过低，无法播放视频，' + t
      }
      var w3c = typeof j.getElementById !== u && typeof j.getElementsByTagName !== u && typeof j.createElement !== u
      var i = 'id="' + N + '" name="' + N + '" '
      var s = ''
      var l = ''
      P['movie'] = C
