<template>
	<cloud-tmpl title='水平' :scrollHeight='35' @close='handleClose'>
		<template v-slot:content>
			...
			<div class="content-coordinate">
				...
				<ul class="content-warp">
					...
					<li>
						<span>Z</span> <span>{{ startCoordinate[2] }}</span>
					</li>
				</ul>
...
export default {
	...
	methods: {
		async setMeasurement() {
			await window.sealAPI._tools.setMeasurement(MeasurementMode.Horizontal, null);
