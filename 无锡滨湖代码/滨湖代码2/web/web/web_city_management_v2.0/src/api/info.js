...
export function getPrecinctList (data) {
  // let url = '/apis/precinct/queryPrecinctList?precinctId=' + data.precinctId
...
export function queryCameraListGroupByKind (data) {
  ...
  let url = '/apis/device/queryCameraListGroupByKind'
  return request({
    url: url,
    method: 'get'
  })
...
export function getDeviceFixedVideo (data) {
  // let url = '/mock/pointList.json'
  let url = '/apis/dahua/getDeviceList'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryCSBJList (data) {
  // let url = '/mock/pointList.json'
  let url = '/apis/cityFirmware/query'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryIndividualList (data) {
  // let url = '/mock/pointList.json'
  let url = '/apis/queryDevice/queryIndividualList?precinctId=510100'
  return request({
    url: url,
    method: 'get'
  })
...
export function getCar (data) {
  // let url = '/mock/pointList.json'
  let url = '/apis/syncCar/query-condition?type=' + data
  return request({
    url: url,
    method: 'get'
  })
...
export function getEmergencyCoordinates (data) {
  // let url = '/mock/pointList.json'
  let url = '/community/siteManage/selectBasicShelter'
  if (data && data != '') {
    url = url + `?isAll=${data}`
  }
  return request({
...
export function getEmergencyExpert(data) {
  // let url = '/mock/pointList.json'
  let url = '/community/basicExpert/getBasicExpertList'
  if (data && data != '') {
    url = url + `?isAll=${data}`
  }
  return request({
...
export function getEmergencySupplies (data) {
  // let url = '/mock/pointList.json'
  let url = '/community/resourceStuff/query-stock'
  if (data && data != '') {
    url = url + `?isAll=${data}`
  }
  return request({
...
export function queryRescueTeamList (data) {
  let url = '/community/teamInfo/queryTeamInfoList?helpType=999'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryReliefMaterialsList (data) {
  let url = '/apis/stockInfo/queryStockInfoList?helpType=999'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryVideoResourcesList (data) {
  let url = '/apis/device/queryDeviceInfoList'
  return request({
    url: url,
    method: 'get'
  })
...
export function getEmergencyType (data) {
  let url = '/apis/teamInfo/emergencyPowerDictList'
  return request({
    url: url,
    method: 'get'
  })
...
export function getEmergencyPower (data) {
  let url = '/apis/teamInfo/emergencyPower'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryReservoirList (data) {
  ...
  return request({
    url: '/apis/reservoir/queryReservoirList',
    method: 'get'
  })
}
...
export function getEmergencyFloodStuff (data) {
  let url = '/apis/teamInfo/emergencyFloodStuff'
  return request({
    url: url,
    method: 'get'
  })
...
export function getShelterInfo (data) {
  let url = '/apis/teamInfo/shelterInfo'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryCoalMine (data) {
  let url = '/apis/center/queryCoalMine'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryEnterprise (data) {
  let url = '/apis/center/queryEnterprise'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryHazard (data) {
  let url = '/apis/center/queryHazard'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryMedicalInstitution (data) {
  let url = '/apis/center/queryMedicalInstitution'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryObservationStation (data) {
  let url = '/apis/center/queryObservationStation'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryProneDisaster (data) {
  let url = '/apis/center/queryProneDisaster'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryRescue (data) {
  let url = '/community/teamInfo/queryRescueTeamInfo'
  if (data && data != '') {
    url = url + `?isAll=${data}`
  }
  return request({
...
export function queryReservoir (data) {
  let url = '/apis/center/queryReservoir'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryTransport (data) {
  let url = '/apis/center/queryTransport'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryWaterlogging (data) {
  let url = '/apis/center/queryWaterlogging'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryWeatherStation (data) {
  let url = '/apis/center/queryWeatherStation'
  return request({
    url: url,
    method: 'get'
  })
...
export function queryWaterDataList (data) {
  ...
  return request({
    url: '/apis/device/queryRiverMonitorInfo?' + data,
    method: 'get'
  })
}
...
export function getdeviceId(data) {
  let url = '/apis/fusion/getVideoListByEventId'
  return request({
    url: url,
    method: 'get'
  })
...
export function getFlvUrl(data) {
  ...
  // let url = '/apis/dahua/getVideoUrl?videoType=FLV_HTTP'
  let url = '/apis/dahua/getVideoUrl?videoType=' + type
  if (data.deviceId) {
...
export function getCityEyeUrl(data) {
  ...
  // let url = '/apis/dahua/getVideoUrl?videoType=FLV_HTTP'
  let url = '/apis/dahua/getCityEyesVideoUrl?protocol=' + type
  if (data.deviceId) {
    url += ('&deviceId=' + data.deviceId)
  }
  let typeObj = {
...
export function queryFlow(data) {
  ...
  // let url = '/apis/eventDeal/getEventDeal'
  let url = '/apis/eventJoint/dealMessage'
  return request({
    url: url,
    method: 'post',
    data: data
