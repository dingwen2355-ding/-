    ...
    GeometryService,
        ...
        return declare(null, {
            ...
            constructor: function (options) {
                ...
                this._font = new Font('12rem').setWeight(Font.WEIGHT_BOLD);
                    ...
                    if (this._measureMethod === "GeometryServer") {
                        ...
                        geometryService.simplify([geometry], function (simplifiedGeometries) {
                            ...
                            geometryService.areasAndLengths(areasAndLengthParams, function (result) {
                                let font = new Font("16rem", Font.STYLE_NORMAL, Font.VARIANT_NORMAL, Font.WEIGHT_BOLDER);
                        ...
                        let font = new Font("18rem", Font.STYLE_NORMAL, Font.VARIANT_NORMAL,
                                                            Font.WEIGHT_BOLDER);
