      ...
      <el-form :model="form" :rules="rules" ref="ruleForm" label-width="566rem" class="NewInstructions-ruleForm">
        <el-form-item label="任务名称" prop="taskTitle" >
          <el-input
            ...
            placeholder="请输入任务标题"
            class="large-screen"
            popper-class="large-screen" style="width:1900rem"
          ></el-input>
        </el-form-item>
        <el-form-item label="节点名称" prop="contactId">
          <el-select style="width:1900rem"
        ...
        <el-form-item label="处置人" prop="person">
          <el-cascader style="width:1900rem"
            class="large-screen"
            popper-class="large-screen"
            ref="deptcascader"
            v-model="selected"
        ...
        <el-form-item>
          ...
          >
          <el-button @click="resetForm('ruleForm')" style="margin-left: 200rem; width: 520rem !important">取消
          </el-button>
        </el-form-item>
      </el-form>
    </div>
