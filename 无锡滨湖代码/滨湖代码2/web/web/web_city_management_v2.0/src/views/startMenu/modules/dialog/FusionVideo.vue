...
import { getFlvUrl } from '@/api/info'
    ...
    getConvergeVideo() {
      ...
      axios.get(url).then(res => {
        if (res.data.code === 200) {
          ...
          if (deviceIds !== null) {
            deviceIds.split(',').forEach((item, index) => {
              ...
              //       this.opaCent[index].url = dataDevice.url
              //       this.opaCent[index].type = dataDevice.type
              //       console.log(this.opaCent);
              //     } else {
              ...
              getFlvUrl({
                ...
                this.opaCent[index].url = res.src
                this.opaCent[index].type = res.type
              })
              console.log(this.opaCent)
            })
          } else {
