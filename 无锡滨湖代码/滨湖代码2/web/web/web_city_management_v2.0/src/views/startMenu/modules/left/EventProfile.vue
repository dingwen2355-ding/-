<template>
  <div class="EventProfile module">
    <SmallTitle :titleList="['指挥调度']" size="big" />
    <img class="button1" src="../../../../assets/global/设置.png" alt="" style="cursor: pointer" @click="lineDialogVisible = true" />
    ...
    <div class="content">
      ...
      <div class="con-line-2">
        ...
        <div class="con-line-4" v-if="info.happen_time">
          <span class="tip-time card"><i class="el-icon-time" style="font-size: 50rem; color: #b3e1fb"></i>发生时间: {{ info.happen_time }}</span> <span class="icon-place"></span>
          <span class="tip-place card" :title="info.address">事发地点: {{ info.address }}</span>
        </div>
      </div>
      <div class="c-content">
<!--        <div class="con-line-4" v-if="info.happen_time">
