const sysConfig = { // eslint-disable-line no-unused-vars
  superControl: false, // 超级权限控制，开启可以绕过统一认证登录（需后台开关配合）
  map: {
  ...
  map3D: {
    src: 'http://2.21.137.156:8086/#/Rtcplayer?eventId='
  },
  defaultPrecinct: {
    precinctId: '',
    precinctName: '成都市'
  ...
  topMenus: [
    ...
    {
      name: '农业大数据',
      url: 'http://2.22.41.1:31005/api/chengyun-login'
    },
    {
      name: '应急综合',
      url: 'http://2.21.1.29/idaas/emer/portal/#/login/index?appId=VqzHSshJAEGWJsHx'
    }
  ],
  defaultEventId: 50
}
