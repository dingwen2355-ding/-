class Draw {
  ...
  drawRectangle(callback) {
    ...
    this.handler.setInputAction(() => {
      ...
      callback && callback({ id: id, position: westSouthEastNorth })
    }, Cesium.ScreenSpaceEventType.RIGHT_CLICK)
  }
  /*******
   * @function: function
  ...
  drawCircle(callback) {
    ...
    this.handler.setInputAction((click) => {
      ...
      let entity = this.viewer.entities.add({
        position: new Cesium.CallbackProperty(function () {
          return new Cesium.Cartesian3.fromDegrees(...lngLat, 0)
        }, false),
        name: 'circle',
        id: id,
        ellipse: {
    ...
    this.handler.setInputAction(() => {
      ...
      this.handler.destroy()
      callback && callback({ id: id, center: lngLat, radius: radius })
    }, Cesium.ScreenSpaceEventType.RIGHT_CLICK)
  }
  /*******
   * @function: function
  ...
  drawPlane(callback) {
    ...
    this.handler.setInputAction((movement) => {
      ...
      callback && callback({ id: id, positions: codeInfo })
    }, Cesium.ScreenSpaceEventType.RIGHT_CLICK)
  }
