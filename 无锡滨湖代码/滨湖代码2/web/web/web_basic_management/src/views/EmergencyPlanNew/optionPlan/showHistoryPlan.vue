<template>
  <div v-if="dialogVisible">
    ...
    >
      ...
      <div class="info_body" v-loading="loading">
        ...
        >
          <el-form-item label="名称" prop="name">
            <el-input clearable v-model="form.name" disabled placeholder="请输入预案名称"></el-input>
          </el-form-item>
          ...
          <!--              <el-form-item label="所属辖区" prop="regionId" v-show="addShow"-->
          <!--                            v-if="isShowRegion &&form.levelId==='9900'">-->
          <!--                <el-select v-model="form.regionId" placeholder="所在辖区" disabled clearable style="width: 100%">-->
          <!--                  <el-option v-for="item in areaList" :value="item.regionId" :label="item.regionName"-->
          <!--                             :key="item.regionId"></el-option>-->
          <!--                </el-select>-->
          <!--              </el-form-item>-->
          <el-form-item
            label="所属辖区"
          ...
          >
            ...
            <!--                <el-button disabled type="primary" size="medium" @click="showTag" icon="el-icon-edit"-->
      ...
      <!--              &lt;!&ndash;              <div style="text-align: right; height: 47px; width: 100%">&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="success" @click="saveGroups()" style="margin-right: 10px">保存</el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="primary" icon="el-icon-plus" @click="addGroupItem()" style="margin-bottom: 10px">&ndash;&gt;-->
      <!--              &lt;!&ndash;                  添加分组&ndash;&gt;-->
      ...
      <!--              &lt;!&ndash;              <div style="text-align: right; height: 47px; width: 100%">&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="success" @click="saveWarningGroups()" style="margin-right: 10px">保存</el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="primary" icon="el-icon-plus" @click="addWarningGroupItem()"&ndash;&gt;-->
      <!--              &lt;!&ndash;                           style="margin-bottom: 10px">添加分组&ndash;&gt;-->
      <!--              &lt;!&ndash;                </el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;              </div>&ndash;&gt;-->
      <!--              <div style="height: calc(100% - 235px); width: 100%; overflow-x: hidden">-->
      ...
      <!--              &lt;!&ndash;              <div style="text-align: right; height: 47px; width: 100%">&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="success" @click="saveResponseGroups()" style="margin-right: 10px">保存</el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="primary" icon="el-icon-plus" @click="addResponseGroupItem()"&ndash;&gt;-->
      <!--              &lt;!&ndash;                           style="margin-bottom: 10px">添加分组&ndash;&gt;-->
      <!--              &lt;!&ndash;                </el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;              </div>&ndash;&gt;-->
      <!--              <div style="height: calc(100% - 235px); width: 100%; overflow-x: hidden">-->
      ...
      <!--              &lt;!&ndash;              <div style="text-align: right; height: 47px; width: 100%">&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="success" @click="saveSafeGroups()" style="margin-right: 10px">保存</el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="primary" icon="el-icon-plus" @click="addSafeGroupItem()" style="margin-bottom: 10px">&ndash;&gt;-->
      <!--              &lt;!&ndash;                  添加分组&ndash;&gt;-->
      <!--              &lt;!&ndash;                </el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;              </div>&ndash;&gt;-->
      <!--              <div style="height: calc(100% - 235px); width: 100%; overflow-x: hidden">-->
      ...
      <!--              &lt;!&ndash;              <div style="text-align: right; height: 47px; width: 100%">&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="success" @click="saveResponseStopGroups()" style="margin-right: 10px">保存</el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button&ndash;&gt;-->
      <!--              &lt;!&ndash;                  type="primary"&ndash;&gt;-->
      <!--              &lt;!&ndash;                  icon="el-icon-plus"&ndash;&gt;-->
      <!--              &lt;!&ndash;                  @click="addResponseStopGroupItem()"&ndash;&gt;-->
      ...
      <!--              &lt;!&ndash;              <div style="text-align: right; height: 47px; width: 100%">&ndash;&gt;-->
      <!--              &lt;!&ndash;                <el-button type="success" @click="saveRewardsDuty()">保存</el-button>&ndash;&gt;-->
      <!--              &lt;!&ndash;              </div>&ndash;&gt;-->
      ...
      <!--          </div>-->
      <!--        </el-collapse-item>-->
      <!--        <el-collapse-item v-if="isCode === 10" title="● 历史版本" name="3">-->
    ...
    ></plan-view-dialog>
    <detail-history
      :dialogVisible.sync="showHistoryPlaneHistory"
      @success="handlePlanSuccess"
      :rowId="rowIdsHistory"
      :formInfo="formPlanInfoHistory"
      :is-code="isPlanCodeHistory"
      :addShow="true"
    ></detail-history>
  </div>
</template>
...
export default {
  name: 'showHistoryPlan',
  // eslint-disable-next-line vue/no-unused-components
  components: { DetailHistory, planViewDialog, AutoEditor },
  ...
  methods: {
    ...
    handleView(row) {
      ...
      // }
      // this.formInfo = row
      this.rowIdsHistory = row.id
      this.showHistoryPlaneHistory = true
      this.isPlanCodeHistory = 0
      if (row.emergencyTypeId && !Array.isArray(row.emergencyTypeId)) {
        row.emergencyTypeId = row.emergencyTypeId.split(',')
      }
      if (row.status === '未发布') {
