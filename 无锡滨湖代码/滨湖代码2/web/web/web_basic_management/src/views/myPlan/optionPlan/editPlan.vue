...
export default {
  components: { emergencyPlanTags, AddPlanDialog, AddAboutDialog, AutoEditor },
  name: 'editPlan',
  data() {
    return {
      EditValue: '',
  ...
  methods: {
    ...
    handleRelease(row) {
      ...
      let url = '/binhuapis/release-plan'
      let params = {
        id: row.id,
    ...
    queryPlanGroupList(id) {
      let url = '/binhuapis/query-group-data?id=' + id
