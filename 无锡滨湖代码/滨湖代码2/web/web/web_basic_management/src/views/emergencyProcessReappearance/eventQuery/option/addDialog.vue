          ...
          <el-form-item label="上传视频">
            <div style="display: flex; align-items: center; margin-top: 20px">
              ...
              <span
                ...
                style="font-size: 14px;margin-left: 20px;margin-top: 50px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;width: 400px;"
              ...
              <span
                :title="videoShow.split('/').pop()"
                style="font-size: 14px;margin-left: 320px;margin-top: 70px;position: absolute;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;width: 400px;"
...
export default {
      ...
      if (v) {
        ...
        if (this.isCode === 0 || this.isCode === 1) {
          ...
          if (this.formInfo.file) {
            this.addForm.video = new window.File(
              [this.formInfo.file],
              this.formInfo.file.split('/').pop(),
              {
                type: 'video/mp4'
              }
            )
  ...
  data() {
    ...
    return {
      ...
      streetList: [],
      communityList: [],
      siteList: [{ id: 0, name: '是' }, { id: 1, name: '否' }],
      impactList: [{ id: 0, name: '1级' }, { id: 1, name: '2级' }, { id: 2, name: '3级' }, { id: 3, name: '4级' }],
      levelList: [{ id: 0, name: '紧急事件' }, { id: 1, name: '一般事件' }],
      videoShow: '',
      addForm: {
        video: ''
      },
  ...
  methods: {
    ...
    getSiteList1() {
      ...
      request.get(url).then((res) => {
        if (res.data.code === 200) {
          let data = res.data.data || []
          this.sourceList = data.filter(item => item.dictName === '演练事件')
          if (this.isCode == 2) {
            this.form.sourceName = this.sourceList[0].dictName
          }
        }
      })
    },
