<template>
  <div class="ConsultationNotice">
        ...
        >
          ...
          <el-table-column fixed="right" label="操作" width="420">
            <template slot-scope="scope">
              ...
              <el-button type="primary" plain size="mini" @click="handleEdit(scope.row, 0)" v-if="scope.row.status != 1"
                >编辑</el-button
              >
              ...
              <el-button type="info" plain size="mini" v-if="scope.row.isTop == '0'" @click="handleTopping(scope.row)"
                >发布</el-button>
    ...
    <activity-management-add :dialogVisible.sync="showAdd" :formInfo="formInfo" :isCode="isCode" @success="success" />
  </div>
</template>
...
import ActivityManagementAdd from "@/views/activityManagement/activityManagementAdd.vue";

export default {
  name: 'activityManagement',
  components: {ActivityManagementAdd },
  data() {
    return {
      statusList: [
        { id: '0', name: '暂存' },
