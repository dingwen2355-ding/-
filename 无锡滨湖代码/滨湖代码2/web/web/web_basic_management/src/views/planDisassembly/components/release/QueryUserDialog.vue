<template>
  <div class="QueryUserDialog" v-if="dialogVisibleUser">
  <el-dialog
      title="指挥长设置"
      width="1800px"
    ...
    <div class="QueryUserDialog-warp">
      <div class="QueryUserDialog-body">
        <div class="QueryUserDialog-item" style="width: 17%">
        ...
        <div class="QueryUserDialog-item" style="width: 8%">
        ...
        <div class="QueryUserDialog-item" style="width: 25%">
          <div class="QueryUserDialog-item-bg"></div>
          <div class="item-content">
            <div class="item-content-title">
              <i class="iconfont iconzhgl_title"></i>
...
export default {
  ...
  components: {},
  props: ['dialogVisibleUser', 'dataInfo'],
  data() {
    return {
  ...
  methods: {
    ...
    submit() {
      // if (!this.$store.getters.precinctId) {
      if (!configs.defaultPrecinct.eventType) return
      // }
      if (this.$store.getters.precinctId) {
