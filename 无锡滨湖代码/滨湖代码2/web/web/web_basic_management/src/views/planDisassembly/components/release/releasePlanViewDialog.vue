<template>
  <div v-if="dialogVisible">
    ...
    <QueryUserDialog :dialogVisibleUser.sync="showAdd" :dataInfo="leaderArr"></QueryUserDialog>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    getAllColonyUnitList() {
      let url = '/cdapis/communication/queryPrecinctList?precinctKind=1,2'
      Axios({
        method: 'get',
        url: url,
        headers: {
    ...
    getArrData3(eventType) {
      ...
      let url =
        '/cdapis/Command/communicationOrderByDepartmentByPrecinctId?eventType=' +
        eventType +
        '&isMax=isMax'
    ...
    submitUpdate() {
      ...
      let params = {
        precinctId: this.$store.getters.precinctId,
        eventType: configs.defaultPrecinct.eventType,
        data: {
          1: {},
          2: cityUnitIdArr,
          3: colonyUnitIdArr,
