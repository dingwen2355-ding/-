  ...
  gaodeMap.FontIconMarker = function (map, opts) {
    ...
    if (label) {
      ...
      if (label.content) {
        ...
        markerCustomLabelDom.innerHTML = "<div style='text-align: center; color: #173672;font-weight:bold;position: relative;font-size: 11px;text-shadow: #FFFFFF 1px 0 0, #FFFFFF 0 1px 0, #FFFFFF -1px 0 0, #FFFFFF 0 -1px 0;white-space:nowrap;'>" + label.content + '</div>'
      }
      if (label.className) {
