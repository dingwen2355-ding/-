...
/**
 * <p>OnGoingConfSubscribe complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="OnGoingConfSubscribe">
 *   &lt;complexContent>
...
@XmlType(name = "OnGoingConfSubscribe", propOrder = {
    "confId"
})
public class OnGoingConfSubscribe
