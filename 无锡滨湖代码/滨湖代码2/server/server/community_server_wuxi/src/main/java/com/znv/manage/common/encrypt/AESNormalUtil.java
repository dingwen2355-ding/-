...
public class AESNormalUtil {
    ...
    public static void main(String[] args) throws Exception {
        String content = "d6c41f3995fe4ca9b1fcca9c6aa2f712";
        ...
        String jsData = aesDecrypt("iksPZcp+Swldq5IR9Na0FUzXg6zg37KR7xxSjtTs6XLY82yADgbDt3mqRUHSdbS7", AES_KEY);
